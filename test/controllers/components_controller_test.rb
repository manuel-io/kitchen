...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { last: @component.last, title: @component.title } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { last: @component.last, title: @component.title } }
